    ...
    _logIcon(_screenWidth - 400, 25, 400, 50, _screenWidth, _screenHeight, "Login / Register", _font)
{
    ...
    _buttons.push_back(Button(true, 0, 100, (screenWidth / 10) * 4 - 50, 50, screenWidth, screenHeight, "Play", "Start the game from the hangar (where pilots can customize their starfighters).", _font, []() { std::cout << "Play" << std::endl; mainClient(); }));
    ...
    _buttons.push_back(Button(true, 0, 250, (screenWidth / 10) * 4 - 50, 50, screenWidth, screenHeight, "Options", "Options of the game.", _font, [this]() { _state = OPTION_MENU; }));
    ...
    _optionButtons.push_back(Button(false, 0, 100, (screenWidth / 10) * 4 - 50, 50, screenWidth, screenHeight, "Sound", "General sound parameters", _font, []() {}));
    ...
    _optionButtons.push_back(Button(true, 10, 450, (screenWidth / 10) * 4 - 50, 50, screenWidth, screenHeight, "Back to main menu", "Return back to main menu", _font, [this]() { _state = IN_MENU; }));
...
void Menu::Menu::_drawOptionMenu()
{
