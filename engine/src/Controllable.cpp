...
{
    r.creatEntity();
    r.emplace_comp(r.currentEntity, Drawable(1, Rectangle{229, 100, 20, 20}, {1.5, 1.5}));
    ...
    r.emplace_comp(r.currentEntity, Explosion(1, 4, -37, 0.2, 10, SHIPSHOOT, Rectangle{180, 300, 40, 40}, {1.5, 1.5}));
}
